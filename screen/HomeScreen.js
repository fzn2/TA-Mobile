...
import IconMaps from '../assets/awan.svg';
...
const HomeScreen = ({navigation}) => {
  ...
  return (
    <View style={styles.backgroud}>
      ...
      <ScrollView horizontal={true} decelerationRate={0} bounces={true} style={{flexDirection: 'row'}}>
      ...
      <View style={styles.card2}>
        <View style={{flexDirection: 'row'}}>
          <IconMaps width={100} height={67} style={{color: '#000000'}} />
          <View style={{flexDirection: 'column'}}>
            <Text style={styles.card2.text}>25 C</Text>
            <Text style={styles.card2.text2}>Berkabut</Text>
            <Text style={styles.card2.text2}>Senin, 29 November 2022</Text>
          </View>
        </View>
        <TouchableOpacity
